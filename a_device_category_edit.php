                  ...
                  <div class="well bs-component">
										...
										<?php
											$sql = "SELECT *
															...
															WHERE id_device_category = $_REQUEST[id]";
											$objQuery = mysql_query($sql);
											$objResult = mysql_fetch_array($objQuery);
										?>

                    <form action="a_device_category_edit_process.php"  id="form"  class="form-horizontal" method="post">
                      <fieldset>
                        <legend>แก้ไขหมวดหมู่อุปกรณ์</legend>

												<div class="form-group">
                          <label class="col-lg-4 control-label"><font color = "red">* </font>ชื่อหมวดหมู่อุปกรณ์</label>
                          <div class="col-lg-8">
                            <input class="form-control" name="device_category_name" id="device_category_name" type="text" placeholder="เช่น อุปกรณ์ส่วนตัว" value="<?=$objResult['device_category_name'];?>">
                          </div>
                        </div>
		...
		<script type="text/javascript">
			$( document ).ready( function () {
				$( "#form" ).validate( {
					...
					messages: {
						device_type_name: "กรุณากรอก ชื่อหมวดหมู่อุปกรณ์"
					},
					errorElement: "em",
