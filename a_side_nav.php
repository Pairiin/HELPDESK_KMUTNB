<aside class="main-sidebar hidden-print">
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      <li class="active"><a href="a_admin.php"><i class="fa fa-home"></i><span>หน้าหลัก</span></a></li>
      <li class="treeview"><a href="#"><i class="fa fa-wrench"></i><span>จัดการข้อมูลพื้นฐาน</span><i class="fa fa-angle-right"></i></a>
        <ul class="treeview-menu">
          <li><a href="a_manage_device.php"><i class="fa fa-circle-o"></i><span>จัดการอุปกรณ์</span></a></li>
          <li><a href="a_manage_device_type.php"><i class="fa fa-circle-o"></i><span>จัดการประเภทอุปกรณ์</span></a></li>
          <li><a href="a_manage_device_category.php"><i class="fa fa-circle-o"></i><span>จัดการหมวดหมู่อุปกรณ์</span></a></li>
          <li><a href="a_manage_problem.php"><i class="fa fa-circle-o"></i><span>จัดการปัญหา</span></a></li>
          <li><a href="a_manage_problem_type.php"><i class="fa fa-circle-o"></i><span>จัดการประเภทปัญหา</span></a></li>
        </ul>
      </li>
