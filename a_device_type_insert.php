              ...
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <div class="well bs-component">
                    ...
                    <form action="a_device_type_insert_process.php"  id="form"  class="form-horizontal" method="post">
                      <fieldset>
                        <legend>เพิ่มประเภทอุปกรณ์</legend>
                          ...
                          <div class="col-lg-8">
                            <input class="form-control" name="device_type_name" id="device_type_name" type="text" placeholder="เช่น อุปกรณ์ส่วนตัว">
                          </div>
                        </div>
