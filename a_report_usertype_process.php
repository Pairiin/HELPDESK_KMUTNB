  ...
  <body class="sidebar-mini fixed">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
          ...
          <div>
            <h1><i class="fa fa-bar-chart fa-lg"></i>รายงานสรุปการแจ้งซ่อมตามประเภทผู้ใช้</h1>
          </div>
        </div>
				<?
			                        ...
			                        <table width="100%"  class="table table-bordered table-striped table-hover table-condensed">
			                          ...
			                          <table width="100%"  class="table table-bordered table-striped table-hover table-condensed">
			                            <tr>
			                              ...
			                              <td width="5%" height="32" align="center"><strong>รหัสการซ่อม</strong></td>
			                              ...
			                              <td width="10%" height="32" align="center"><strong>ชื่ออุปกรณ์</strong></td>
			                              <td width="10%" height="32" align="center"><strong>ประเภทอุปกรณ์</strong></td>
			                              <td width="7%" height="32" align="center"><strong>ประเภทผู้ใช้งาน</strong></td>
			                            </tr>
			                            ...
			                            <?php
																	...
																	LEFT JOIN user_status ON repair.id_user_status=user_status.id_user_status 
																	WHERE date_s BETWEEN '$date_start' AND '$date_end' AND user_status.id_user_status='$_REQUEST[id_user_status]'";
			                            ...
			                            while($objResult =mysql_fetch_array($result)){
			                             ?>
			                              <tr>
				                              ...
				                              <td align="center"><?php echo $objResult[name_user_status]; ?></td>
			                            <? $i+=1; }?>
												...
												<center><a class="btn btn-info" href="a_print_usertype.php?date_start=<? echo $_REQUEST['date_start'];?>&date_end=<? echo $_REQUEST['date_end'];?>&id_user_status=<? echo $_REQUEST[id_user_status];?>" target="_blank">รายงาน</a>
												<a class="btn btn-success" href="a_chartpie_usertype.php?date_start=<? echo $_REQUEST['date_start'];?>&date_end=<? echo $_REQUEST['date_end'];?>&id_user_status=<? echo $_REQUEST[id_user_status];?>" >กราฟ</a></center>
						...
						<script>
							 setTimeout(function() {
									 swal({
											 ...
											 window.location = "a_report_usertype.php";
									 }, 1000);
							 });
					 </script>
				 <? }?>
