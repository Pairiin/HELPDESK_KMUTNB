              ...
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <div class="well bs-component">
                    <form action="a_problem_insert_process.php" id="form" class="form-horizontal" method="get">
                      <fieldset>
                        <legend>เพิ่มปัญหา</legend>
												<div class="form-group">
                          <label class="col-lg-4 control-label" for="textArea"><font color="red">* </font>รายละเอียดปัญหา</label>
                          <div class="col-lg-8">
                            <textarea class="form-control" id="problem_name" rows="3" name="problem_name"></textarea>
                          </div>
                        </div>
                          ...
                          <div class="col-lg-8">
					                    ...
					                    <option value=""><-- กรุณาเลือก --></option>
					                      ...
					                      $sql_problem_type = "SELECT *
					                                      FROM problem_type WHERE status = 'ใช้งาน'";
					                      ...
					                      {
																	?>
																	<option value="<?php echo $result_problem_type["id_problem_type"];?>"><?php echo $result_problem_type["id_problem_type"]." - ".$result_problem_type["problem_type_name"];?></option>
					                      <?}?>
					                  </select>
                          </div>
                        </div>
                          ...
                          <div class="col-lg-8">
                            <textarea class="form-control" id="solution_problem" rows="3" name="solution_problem"></textarea>
                          </div>
                        </div>
                        <div class="form-group">
