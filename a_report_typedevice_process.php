			                        ...
			                        <table width="100%"  class="table table-bordered table-striped table-hover table-condensed">
			                          ...
			                          <table width="100%"  class="table table-bordered table-striped table-hover table-condensed">
			                            ...
			                            <? $i+=1; }?>
												...
												<center><a class="btn btn-info" href="a_print_device_type.php?date_start=<? echo $_REQUEST['date_start'];?>&date_end=<? echo $_REQUEST['date_end'];?>&id_device_type=<? echo $_REQUEST[id_device_type];?>" target="_blank">รายงาน</a>
												<a class="btn btn-success" href="a_chartpie_devicetype.php?date_start=<? echo $_REQUEST['date_start'];?>&date_end=<? echo $_REQUEST['date_end'];?>&id_device_type=<? echo $_REQUEST[id_device_type];?>" >กราฟ</a></center>
						...
						<script>
							 setTimeout(function() {
									 swal({
											 ...
											 window.location = "a_report_typedevice.php";
									 }, 1000);
							 });
					 </script>
				 <? }?>
